/*===============================================================================================
 ...
 IMPORTANT!!! You must copy fmod.dll to fmod2.dll or libfmod-3.71.so to libfmod-3.71_2.so to
...
#else
  #define FMOD_LIB  "libfmod-3.71.so"
  #define FMOD_LIB2 "libfmod-3.71_2.so"
#endif
