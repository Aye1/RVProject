...
{ =============================================================================================== }
{
  ...
  or libfmod-3.62.so (in Linux) installed.
  ...
  In Linux, make sure you are signed in as root and copy the libfmod-3.62.so
  ...
  a symbolic link between libfmod-3.62.so and libfmod.so. This is done with
  the following command (assuming you are in /usr/lib/)...
  ln -s libfmod-3.62.so libfmod.so.
}
{ =============================================================================================== }
