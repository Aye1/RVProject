...
// actuellement le fob est fait pour marcher en standalone et en mode
// master/slave avec seulement le master branch̩ en RS232
...
//		ou on rajouter pour permettre la connexion de plusieurs fob.
//  0   ajouter timestamp
//	/
//	X
//
...
//      2010/01/28 : Konubinix : Correction : SetAutoConfiguration
//      needs at least 600ms of sleep before and after the command is
//      sent via RS232. The attribute nb_flock was not updated when
