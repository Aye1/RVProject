...
//
// Purpose : classe interface d'utilisation du Fob.  Elle permet de
// recuperer directement les types de donnees voulu dans le modele
// geometrique standard. Cette classe masque la gestion et les
// commandes envoyes au Fob. elle permet de gerer un ou plusieurs FOB
// utilise en mode 1 Fob / 1 RS232 et le mode master/slave avec
// seulement le master en RS232 et les slaves branch̩s dessus via
// FBB. le driver ne supporte pas le mode etendu.(plus de 14 FOB).
//rem:
...
//      2010/01/28 : Konubinix : Correction de Ajout de InitSlaveUnSeulRS232 et changement de InitMaster pour
//      permettre le mode multi fob Master/Slaves via un seul RS232
///////////////////////////////////////////////////////////////////////////////
