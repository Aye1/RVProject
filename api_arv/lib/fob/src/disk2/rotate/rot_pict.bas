...
PRINT
PRINT
PRINT "The green axis corresponds to the receiver's X axis"
PRINT "The blue axis corresponds to the receiver's Y axis"
PRINT "The red axis corresponds to the receiver's Z axis"
