...
/*! ---------------------------------------------------------------------------
*
*   file ARVGloveFobDemo.C
*   author Raphael Grasset
*   version 1.0
*   date 15/04/2004 
*   purpose record new pattern from image
    note modified from the original code of mk_patt.c
*/
...
char            *vconf = "-channel=2 -mode=PAL -dev=/dev/video0 -width=640 -height=480";
